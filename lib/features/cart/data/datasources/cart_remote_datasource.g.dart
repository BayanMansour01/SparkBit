...
class _CartRemoteDataSource implements CartRemoteDataSource {
  ...
  Future<BaseResponse<OrderResponseModel>> createOrder(
    ...
    final _options = _setStreamType<BaseResponse<OrderResponseModel>>(
    ...
    late BaseResponse<OrderResponseModel> _value;
    try {
      _value = BaseResponse<OrderResponseModel>.fromJson(
        _result.data!,
        (json) => OrderResponseModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
