...
class _ProfileRemoteDataSource implements ProfileRemoteDataSource {
  ...
  @override
  Future<BaseResponse<DataWrapper<UserProfile>>> getProfile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<DataWrapper<UserProfile>>>(
    ...
    late BaseResponse<DataWrapper<UserProfile>> _value;
    try {
      _value = BaseResponse<DataWrapper<UserProfile>>.fromJson(
        _result.data!,
        (json) => DataWrapper<UserProfile>.fromJson(
