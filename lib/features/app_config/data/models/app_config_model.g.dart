...
_AppConfigModel _$AppConfigModelFromJson(Map<String, dynamic> json) =>
    _AppConfigModel(
      latestAndroidVersion: json['latest_android_version'] as String,
      latestSupportedAndroidVersion:
          json['latest_supported_android_version'] as String,
      updateAndroidFeatures: json['update_android_features'] as String,
      latestIosVersion: json['latest_ios_version'] as String,
      latestSupportedIosVersion: json['latest_supported_ios_version'] as String,
